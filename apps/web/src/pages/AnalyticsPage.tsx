...
const initialSummary: ReportSummary = {
  ...
  metrics: [
    { label: "Messages checked", value: 0, suffix: "", delta: "-", tone: "neutral" },
    { label: "Issues caught", value: 0, suffix: "", delta: "-", tone: "warning" },
    { label: "Compliance quality", value: 100, suffix: "%", delta: "-", tone: "success" },
    { label: "Review queue", value: 0, suffix: "", delta: "-", tone: "neutral" }
  ],
  departmentRisk: [],
  policyViolations: [],
  trend: [0],
